			...
			<div className="flex justify-center space-x-4 flex-wrap md:flex-nowrap overflow-hidden">
				{team.map((member, index) => {
					return (
						...
						>
							<motion.div
								className="overflow-hidden rounded-md from-cyan-400 to-transparent p-[1.5px] group-odd:bg-gradient-to-b group-even:bg-gradient-to-t"
							...
							>
								<img
									src={member[0]}
									className="w-40 h-48 rounded-md object-cover object-top md:w-60 md:h-80"
								/>
							</motion.div>
							<motion.h1
